          ...
          <div className='main-layout'>
            ...
            <div className='layout-2'>
              <Form.Item label='Username'>
                <Input
                  value={department?.information?.manager?.username}
                  readOnly
                />
              </Form.Item>
              <Form.Item label='Name'>
                <Input
                  value={department?.information?.manager?.name}
                  readOnly
                />
              </Form.Item>
            </div>
            <div className='layout-3'>
              <Form.Item label='Email'>
                <Input
                  value={department?.information?.manager?.email}
                  readOnly
                />
              </Form.Item>
              <Form.Item label='Phone'>
                <Input
                  value={department?.information?.manager?.phone}
                  readOnly
                />
              </Form.Item>
              <Form.Item label='birthday'>
                <DatePicker
                  value={department?.information?.manager?.birthday}
                  format='DD/MM/YYYY'
                  disabled
                />
              </Form.Item>
